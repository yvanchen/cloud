package com.gitchain.core.auto.factories;

import com.gitchain.core.auto.annotation.AutoIgnore;
import com.gitchain.core.auto.common.AbstractChainProcessor;
import com.gitchain.core.auto.common.BootAutoType;
import com.gitchain.core.auto.common.MultiSetMap;
...
public class AutoFactoriesProcessor extends AbstractChainProcessor {
    /**
     * 处理的注解 @FeignClient
     */
     ...
     * Feign 自动配置
     */
    private static final String FEIGN_AUTO_CONFIGURE_KEY = "com.gitchain.core.cloud.feign.ChainFeignAutoConfiguration";
    /**
    ...
    private void generateFactoriesFiles() throws Exception {
