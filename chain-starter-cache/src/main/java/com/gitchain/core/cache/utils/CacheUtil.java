package com.gitchain.core.cache.utils;
		...
		try {
			...
			if (valueWrapper == null) {
				...
				if (ObjectUtil.isNotEmpty(call)) {
					Field field = ReflectUtil.getField(call.getClass(), ChainConstant.DB_PRIMARY_KEY);
					if (ObjectUtil.isNotEmpty(field) && ObjectUtil.isEmpty(ClassUtil.getMethod(call.getClass(), ChainConstant.DB_PRIMARY_KEY_METHOD).invoke(call))) {
						return null;
					}
