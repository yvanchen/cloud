package com.gitchain.core.redis.ratelimiter;
...
import com.gitchain.core.tool.spel.ChainExpressionEvaluator;
import com.gitchain.core.tool.utils.CharPool;
...
public class RedisRateLimiterAspect implements ApplicationContextAware {
	 ...
	 * 表达式处理
	 */
	private final ChainExpressionEvaluator evaluator = new ChainExpressionEvaluator();
	/**
	 * redis 限流服务
	 */
