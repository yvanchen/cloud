...
import com.gitchain.core.redis.ratelimiter.RedisRateLimiterAspect;
import com.gitchain.core.redis.ratelimiter.RedisRateLimiterClient;
...
@ConditionalOnProperty(value = "chain.redis.rate-limiter.enabled", havingValue = "true")
public class RateLimiterAutoConfiguration {

	@SuppressWarnings("unchecked")
	private RedisScript<List<Long>> redisRateLimiterScript() {
		DefaultRedisScript redisScript = new DefaultRedisScript<>();
		redisScript.setScriptSource(new ResourceScriptSource(new ClassPathResource("META-INF/scripts/base_rate_limiter.lua")));
