...
public class ChainProperties implements EnvironmentAware, EnvironmentCapable {
	@Nullable
	private Environment environment;

	/**
	 * 装载自定义配置chain.prop.xxx
	 */
	@Getter
	...
	public String getEnv() {
		...
		String env = environment.getProperty("chain.env");
		Assert.notNull(env, "请使用 ChainApplication 启动...");
		return env;
	}
	...
	public String getName() {
		Objects.requireNonNull(environment, "Spring boot 环境下 Environment 不可能为null");
		return environment.getProperty("spring.application.name", environment.getProperty("chain.name", ""));
	}
