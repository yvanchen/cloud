package com.gitchain.core.launch.constant;
...
public interface AppConstant {
	 ...
	 * 应用版本
	 */
	String APPLICATION_VERSION = "2.9.0.RELEASE";

	/**
	 * 基础包
	 */
	String BASE_PACKAGES = "com.gitchain";

	/**
	 * 应用名前缀
	 */
	String APPLICATION_NAME_PREFIX = "chain-";
	/**
	 * 网关模块名称
	 */
