package com.gitchain.core.secure.aspect;

import org.aspectj.lang.ProceedingJoinPoint;
import org.aspectj.lang.annotation.Around;
import org.aspectj.lang.annotation.Aspect;
import org.aspectj.lang.reflect.MethodSignature;
import com.gitchain.core.secure.annotation.PreAuth;
import com.gitchain.core.secure.auth.AuthFun;
import com.gitchain.core.secure.exception.SecureException;
...
public class AuthAspect implements ApplicationContextAware {
	 ...
	 */
	@Around(
		"@annotation(com.gitchain.core.secure.annotation.PreAuth) || " +
			"@within(com.gitchain.core.secure.annotation.PreAuth)"
	)
