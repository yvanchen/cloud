...
@AllArgsConstructor
@EnableConfigurationProperties(ChainHttpCacheProperties.class)
@ConditionalOnProperty(value = "chain.http.cache.enabled", havingValue = "true")
public class HttpCacheConfiguration implements WebMvcConfigurer {
	...
	private final ChainHttpCacheProperties properties;
