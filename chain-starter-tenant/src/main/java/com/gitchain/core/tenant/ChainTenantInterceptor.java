...
public class ChainTenantInterceptor extends TenantLineInnerInterceptor {
	 ...
	 * 租户配置文件
	 */
	private ChainTenantProperties tenantProperties;
	/**
	 * 超管需要启用租户过滤的表
	 */
	private List<String> adminTenantTables = Arrays.asList("base_top_menu", "base_dict_biz");
