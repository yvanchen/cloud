...
import com.gitchain.core.tool.jackson.ChainJacksonProperties;
import com.gitchain.core.tool.jackson.ChainJavaTimeModule;
...
@EnableConfigurationProperties(ChainJacksonProperties.class)
public class JacksonConfiguration {
	...
	public ObjectMapper objectMapper(Jackson2ObjectMapperBuilder builder) {
		...
		//日期格式化
		objectMapper.registerModule(ChainJavaTimeModule.INSTANCE);
