 ...
 * @author git
 */
public class ChainExpressionEvaluator extends CachedExpressionEvaluator {
	...
	public EvaluationContext createContext(Method method, Object[] args, Object target, Class<?> targetClass, @Nullable BeanFactory beanFactory) {
		...
		ChainExpressionRootObject rootObject = new ChainExpressionRootObject(method, args, target, targetClass, targetMethod);
