...
import com.gitchain.core.tool.utils.DateTimeUtil;
 ...
 * @author git
 */
public class ChainJavaTimeModule extends SimpleModule {
	public static final ChainJavaTimeModule INSTANCE = new ChainJavaTimeModule();

	public ChainJavaTimeModule() {
