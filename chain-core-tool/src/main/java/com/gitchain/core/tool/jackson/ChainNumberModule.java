 ...
 * @author git
 */
public class ChainNumberModule extends SimpleModule {
	public static final ChainNumberModule INSTANCE = new ChainNumberModule();

	public ChainNumberModule() {
		super(ChainNumberModule.class.getName());
