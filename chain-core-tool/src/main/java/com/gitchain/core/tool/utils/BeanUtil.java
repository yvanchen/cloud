...
import com.gitchain.core.tool.beans.BeanProperty;
import com.gitchain.core.tool.beans.ChainBeanCopier;
import com.gitchain.core.tool.beans.ChainBeanMap;
import com.gitchain.core.tool.convert.ChainConverter;
...
public class BeanUtil extends org.springframework.beans.BeanUtils {
	...
	public static <T> T copy(@Nullable Object source, Class sourceClazz, Class<T> targetClazz) {
		...
		ChainBeanCopier copier = null;
		T to = newInstance(targetClazz);
		try {
			copier = ChainBeanCopier.create(sourceClazz, targetClazz, false);
			copier.copy(source, to, null);
		} catch (Exception e) {
			copyProperties(source, to, targetClazz);
		}
		return to;
	...
	public static void copy(@Nullable Object source, @Nullable Object targetBean) {
		...
		ChainBeanCopier copier = ChainBeanCopier
	...
	public static <T> T copyWithConvert(@Nullable Object source, Class<?> sourceClazz, Class<T> targetClazz) {
		...
		ChainBeanCopier copier = ChainBeanCopier.create(sourceClazz, targetClazz, true);
		T to = newInstance(targetClazz);
		copier.copy(source, to, new ChainConverter(sourceClazz, targetClazz));
		return to;
	}
	...
	public static Map<String, Object> toMap(@Nullable Object bean) {
		...
		return ChainBeanMap.create(bean);
	}
