...
import com.gitchain.core.cloud.hystrix.ChainHystrixAutoConfiguration;
 ...
 */
@NoArgsConstructor
public class ChainFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
	@Getter
	...
	private Class<?> getSpringFactoriesLoaderFactoryClass() {
		return ChainHystrixAutoConfiguration.class;
	}
