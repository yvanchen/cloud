...
/**
 * 添加 chain 默认的 fallbackFactory  2019.01.19
 *
 * @author git 
 * @author git
 * @author git 
...
public class ChainHystrixTargeter implements Targeter {
	...
	public <T> T target(FeignClientFactoryBean factory, Feign.Builder feign, FeignContext context,
		...
		// chain 默认的 fallbackFactory
		ChainFallbackFactory chainFallbackFactory = new ChainFallbackFactory(target);
		return (T) builder.target(target, chainFallbackFactory);
	}
