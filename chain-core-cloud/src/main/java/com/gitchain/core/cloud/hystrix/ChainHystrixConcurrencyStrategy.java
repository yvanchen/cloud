...
import com.gitchain.core.context.ChainCallableWrapper;
 ...
 */
@AllArgsConstructor
public class ChainHystrixConcurrencyStrategy extends HystrixConcurrencyStrategy {
	@Nullable
	...
	public <T> Callable<T> wrapCallable(Callable<T> callable) {
		Callable<T> wrapCallable = new ChainCallableWrapper<>(callable);
		return existingConcurrencyStrategy != null
