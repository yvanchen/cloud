...
import com.gitchain.core.cloud.http.logger.HttpLoggingInterceptor;
import com.gitchain.core.cloud.http.logger.OkHttpSlf4jLogger;
import com.gitchain.core.tool.ssl.DisableValidationTrustManager;
import com.gitchain.core.tool.ssl.TrustAllHostNames;
import com.gitchain.core.tool.utils.Charsets;
import com.gitchain.core.tool.utils.Holder;
...
@ConditionalOnProperty(value = "chain.http.enabled", matchIfMissing = true)
public class RestTemplateConfiguration {
	private final ChainHttpProperties properties;
	...
	@RequiredArgsConstructor
	@ConditionalOnClass(OkHttpClient.class)
	@ConditionalOnProperty(value = "chain.http.rest-template.enable")
	...
	@RequiredArgsConstructor
	@ConditionalOnClass(OkHttpClient.class)
	@ConditionalOnProperty(value = "chain.http.lb-rest-template.enable")
