...
@Slf4j
@AllArgsConstructor
public class ChainFeignFallback<T> implements MethodInterceptor {
	...
	public Object intercept(Object o, Method method, Object[] objects, MethodProxy methodProxy) throws Throwable {
		...
		log.error("ChainFeignFallback:[{}.{}] serviceId:[{}] message:[{}]", targetType.getName(), method.getName(), targetName, errorMessage);
	...
	public boolean equals(Object o) {
		...
		ChainFeignFallback<?> that = (ChainFeignFallback<?>) o;
