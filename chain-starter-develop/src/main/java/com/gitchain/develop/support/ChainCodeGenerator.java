package com.gitchain.develop.support;
...
import com.gitchain.develop.constant.DevelopConstant;
...
public class ChainCodeGenerator {
	 ...
	 * 代码所在系统
	 */
	private String systemName = DevelopConstant.CHAIN_UI;
	/**
	 * 代码模块名称
	 */
	 ...
	 * 代码所在服务名
	 */
	private String serviceName = "chain-service";
	/**
	 * 代码生成的包名
	 */
	private String packageName = "com.gitchain.test";
	/**
	 * 代码后端生成的地址
	 */
	 ...
	 * 需要去掉的表前缀
	 */
	private String[] tablePrefix = {"base_"};
	/**
	 * 需要生成的表名(两者只能取其一)
	 */
	private String[] includeTables = {"base_test"};
	/**
	 * 需要排除的表名(两者只能取其一)
	 */
	...
	public void run() {
		...
		if (hasSuperEntity) {
			strategy.setSuperEntityClass("com.gitchain.core.mp.base.BaseEntity");
			strategy.setSuperEntityColumns(superEntityColumns);
			strategy.setSuperServiceClass("com.gitchain.core.mp.base.BaseService");
			strategy.setSuperServiceImplClass("com.gitchain.core.mp.base.BaseServiceImpl");
		} else {
			strategy.setSuperServiceClass("com.baomidou.mybatisplus.extension.service.IService");
			strategy.setSuperServiceImplClass("com.baomidou.mybatisplus.extension.service.impl.ServiceImpl");
		}
		// 自定义 controller 父类
		strategy.setSuperControllerClass("com.gitchain.core.boot.ctrl.ChainController");
	...
	private InjectionConfig getInjectionConfig() {
		...
		if (Func.isNotBlank(packageWebDir)) {
			if (Func.equals(systemName, DevelopConstant.CHAIN_UI)) {
	...
	public String getOutputDir() {
		return (Func.isBlank(packageDir) ? System.getProperty("user.dir") + "/chain-ops/chain-develop" : packageDir) + "/src/main/java";
	}
